...
Pod::Spec.new do |s|
  s.name             = 'AeroSwift'
  s.version          = '0.1.0'
  s.summary          = 'A short description of AeroSwift.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Dejan Jevtic/AeroSwift'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Dejan Jevtic' => 'dejanjevtic87@gmail.com' }
  s.source           = { :git => 'https://github.com/Dejan Jevtic/AeroSwift.git', :tag => s.version.to_s }
